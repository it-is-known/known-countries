...
READMER = 'readmer'  # See: https://readmer.dev
...
readmer = ->(t, _) { sh "#{READMER} render #{t.prerequisites.first} > #{t.name}" }

task :default => %w[README.md dart python ruby rust]
file 'README.md' => %w[.config/readmer/README.md.liquid], &readmer

task dart: %w[dart/README.md dart/lib/src/country.dart]
file 'dart/README.md' => %w[.config/readmer/dart/README.md.liquid data/countries.csv], &readmer
...
file 'python/README.md' => %w[.config/readmer/python/README.md.liquid data/countries.csv], &readmer
...
file 'ruby/README.md' => %w[.config/readmer/ruby/README.md.liquid data/countries.csv], &readmer
...
file 'rust/README.md' => %w[.config/readmer/rust/README.md.liquid data/countries.csv], &readmer
