...
```toml
[dependencies]
known-countries = { version = "0", default-features = false, features = ["serde"] }
```
...
[docs.rs/known-countries](https://docs.rs/known-countries)
...
[feature flags]: https://github.com/it-is-known/known-countries/blob/master/rust/Cargo.toml
